...
const content = {
  en: {
    ...
    testimonials: {
      ...
      items: [
        ...
        { name: "Anand Upadhyay", location: "Indore, MP", avatar: "AU", rating: 4, text: "Facing delayed salary issues. Through NyayMitra I connected with a lawyer instantly who guided me on the right steps and helped me resolve the situation." },
    ...
    social: {
      instagram: "https://www.instagram.com/nyaymitra.tech",
      linkedin: "https://www.linkedin.com/company/nyaymitra-tech-pvt-ltd",
    },
  },
  ...
  hi: {
    ...
    social: {
      instagram: "https://instagram.com/nyaymitra",
      linkedin: "https://linkedin.com/company/nyaymitra",
    },
  },
}
...
export default function HomePage() {
  ...
  const whatsappMessage = encodeURIComponent("I need help with my legal issue")
  const whatsappUrl = `https://wa.me/${t.hero.whatsappNumber}?text=${whatsappMessage}`
              ...
              <div>
                ...
                <div className="flex flex-col sm:flex-row flex-wrap gap-2.5 mb-8 md:mb-11">
                  ...
                  <Link href="/lawyers" className="w-full sm:w-auto">
                    <button className="w-full inline-flex items-center justify-center gap-2 px-5 py-3 bg-white/[0.05] hover:bg-white/[0.09] text-white font-semibold rounded-xl border border-white/[0.1] hover:border-white/[0.18] text-[13.5px] hover:-translate-y-[1px] active:translate-y-0 transition-all">
                      <Gavel style={{ width: 15, height: 15 }} />{t.hero.ctaSecondary}
                    </button>
                  </Link>
                  <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto">
                    <button className="w-full inline-flex items-center justify-center gap-2 px-5 py-3 text-[#4ade80] font-semibold rounded-xl border border-[#25D366]/[0.17] hover:border-[#25D366]/30 text-[13.5px] hover:-translate-y-[1px] active:translate-y-0 transition-all"
        ...
        <section className="relative z-10 py-16 md:py-28 px-4 sm:px-6 lg:px-8">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-10 md:mb-16">
              ...
              <h2 className="text-2xl sm:text-[38px] font-bold text-white tracking-tight">{t.howItWorks.title}</h2>
            </div>
            <div className="grid md:grid-cols-3 gap-6 relative">
              ...
              {t.howItWorks.steps.map((step, i) => (
                <div key={step.n} className="relative flex flex-col items-center text-center group">
                  ...
                  <p className="text-[12.5px] text-slate-600 leading-relaxed max-w-[220px] mx-auto">{step.desc}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-8 md:mb-12">
              <div>
                ...
                <h2 className="text-2xl sm:text-[38px] font-bold text-white tracking-tight">{t.services.title}</h2>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <Link href="/affidavit-online-india"
                ...
                <div className="absolute top-0 right-0 w-40 sm:w-52 h-40 sm:h-52 pointer-events-none"
                ...
                <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3 mb-4 sm:mb-5">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-xl bg-blue-600/[0.11] border border-blue-500/[0.17] flex items-center justify-center text-blue-400">
                    ...
                    <div>
                      ...
                      <h3 className="text-[13px] sm:text-[14.5px] font-bold text-white group-hover:text-blue-300 transition-colors">{t.services.featured.title}</h3>
                    </div>
                  </div>
                ...
                <p className="text-[11.5px] sm:text-[12.5px] text-slate-500 leading-relaxed mb-4 sm:mb-5 max-w-md">{t.services.featured.desc}</p>
              ...
              {t.services.cards.map((card, i) => (
                <Link key={card.title} href={card.href}
                  ...
                  <h3 className="text-[13px] sm:text-[13.5px] font-bold text-white mb-2">{card.title}</h3>
                  <p className="text-[11.5px] sm:text-[12.5px] text-slate-600 leading-relaxed flex-1">{card.desc}</p>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12 md:gap-16 items-center">
              <div>
                ...
                <h2 className="text-2xl sm:text-[38px] font-bold text-white tracking-tight leading-[1.1] mb-5">
                  {t.whyUs.title}<br /><span className="text-slate-500">{t.whyUs.titleLine2}</span>
                </h2>
                <p className="text-[13px] sm:text-[13.5px] text-slate-500 leading-[1.7] sm:leading-[1.82] mb-8 max-w-md">{t.whyUs.desc}</p>
                <Link href="/legal-gpt">
              ...
              <div className="grid grid-cols-2 gap-3">
                {t.whyUs.features.map((f, i) => (
                  <div key={f.title} className="border border-white/[0.055] rounded-xl p-4 sm:p-5 hover:border-white/[0.09] transition-all"
                    style={{ background: "rgba(255,255,255,0.016)" }}>
                    <div className={`w-8 h-8 sm:w-9 sm:h-9 rounded-lg flex items-center justify-center mb-3 ${whyColor[i]}`}>
                      {whyIcons[i]}
                    </div>
                    <h3 className="text-[12px] sm:text-[13px] font-semibold text-white mb-1">{f.title}</h3>
                    <p className="text-[11px] sm:text-[12px] text-slate-600 leading-relaxed">{f.desc}</p>
                  </div>
                ))}
              </div>
            </div>
        ...
        <section className="relative z-10 py-16 md:py-28 px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-8 md:mb-12">
              ...
              <h2 className="text-2xl sm:text-[38px] font-bold text-white tracking-tight">{t.problems.title}</h2>
            </div>
        ...
        <section className="relative z-10 py-16 md:py-28 px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-8 md:mb-12">
              ...
              <h2 className="text-2xl sm:text-[38px] font-bold text-white tracking-tight">{t.testimonials.title}</h2>
            </div>
                ...
                <div key={item.name}
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-white/[0.05]">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="text-[12px] sm:text-[13px] font-semibold text-white">{item.name}</div>
                        <div className="text-[10px] sm:text-[11px] text-slate-700">{item.location}</div>
                      </div>
                    </div>
                    <div className="flex items-center gap-1 text-[9px] sm:text-[10px] text-slate-700">
                      <CheckCircle className="text-emerald-600" style={{ width: 9, height: 9 }} />
        ...
        <section className="relative z-10 py-16 md:py-24 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="relative overflow-hidden rounded-2xl border border-blue-500/[0.14] p-8 sm:p-10 md:p-14 text-center"
              ...
              <div className="relative">
                <h2 className="text-2xl sm:text-[38px] font-bold text-white tracking-tight mb-4">{t.cta.title}</h2>
                <p className="text-[12.5px] sm:text-[13.5px] text-slate-500 mb-6 sm:mb-8 max-w-xl mx-auto leading-relaxed">{t.cta.subtitle}</p>
                <div className="flex flex-col sm:flex-row gap-3 justify-center">
                  <Link href="/legal-gpt" className="w-full sm:w-auto">
                    <button className="w-full inline-flex items-center justify-center gap-2 px-6 sm:px-7 py-3.5 bg-blue-600 hover:bg-blue-500 text-white font-semibold rounded-xl shadow-xl shadow-blue-600/22 text-[13.5px] hover:-translate-y-[1px] transition-all">
                      <Sparkles style={{ width: 14, height: 14 }} />{t.cta.primary}
                    </button>
                  </Link>
                  <Link href="/lawyers" className="w-full sm:w-auto">
                    <button className="w-full inline-flex items-center justify-center gap-2 px-6 sm:px-7 py-3.5 bg-white/[0.04] hover:bg-white/[0.08] text-white font-semibold rounded-xl border border-white/[0.1] hover:border-white/[0.17] text-[13.5px] hover:-translate-y-[1px] transition-all">
                      {t.cta.secondary}
                    </button>
                  </Link>
                </div>
